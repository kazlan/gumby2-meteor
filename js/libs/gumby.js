...
// initialize Gumby
Gumby2.prototype.init = function(options) {
	var scope = this,
...
Gumby2.prototype.ready = function(code) {
...
Gumby2.prototype.oldie = function(code) {
	if(code && typeof code === 'function') {
		this.onOldie = code;
	}
...
Gumby2.prototype.touch = function(code) {
	if(code && typeof code === 'function') {
		this.onTouch = code;
	}
...
Gumby2.prototype.console = function(type, data) {
...
Gumby2.prototype.log = function() { this.console('log', arguments); };
Gumby2.prototype.debug = function() { this.console('debug', arguments); };
Gumby2.prototype.warn = function() { this.console('warn', arguments); };
Gumby2.prototype.error = function() { this.console('error', arguments); };

// public helper - return debuggin object including uiModules object
Gumby2.prototype.dump = function() {
	return {
		$dom: this.$dom,
...
Gumby2.prototype.selectAttr = function() {
	var i = 0;
...
Gumby2.prototype.addInitalisation = function(ref, code) {
	this.inits[ref] = code;
};

// initialize a uiModule, single / array of module refs 
Gumby2.prototype.initialize = function(ref, all) {
...
// store a UI module
Gumby2.prototype.UIModule = function(data) {
	var module = data.module;
	this.uiModules[module] = data;
};

// loop round and init all UI modules
Gumby2.prototype.initUIModules = function(mods) {
